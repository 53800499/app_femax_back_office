        ...
        <div className="animate-pulse">
          <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
            <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
              <div className="w-20 h-20 bg-gray-300 rounded-full dark:bg-gray-700"></div>
              <div className="order-3 xl:order-2">
                <div className="h-6 bg-gray-300 rounded w-32 mb-2 dark:bg-gray-700"></div>
                <div className="h-4 bg-gray-300 rounded w-48 dark:bg-gray-700"></div>
              </div>
            </div>
          </div>
        </div>
